...
public class Method extends FieldOrMethod {
  ...
  private void decompileCode(PrintStream out, String indent, String className, String superClassName) throws Exception {
    ...
    InstructionList instructionList = new InstructionList(instructions, getLocalVariableTable());
    instructionList.decompile(out, indent, className, superClassName.replace("/", "."));
  }
}
